...
export const fetchUserPosts = async (userId: number): Promise<Post[]> => {
  ...
  const posts: Post[] = [
    ...
    { id: 2, userId: 1, title: '두 번째 게시글', body: 'TanStack Query 공부 중입니다.' },
    { id: 3, userId: 2, title: '리액트 공부', body: '리액트는 정말 재미있어요.' },
    { id: 4, userId: 3, title: '타입스크립트 팁', body: '타입스크립트 사용법을 공유합니다.' },
  ]
